  ...
  <div class="v3d-player" :class="fillCls" ref="refPlayer">
    ...
    <div class="v3d-shade" :class="statusCls" :style="posterImg">
      <div class="v3d-center" v-if="isReady">
        <svg class="svg-center" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          <path
            d="M512 12C236.31 12 12 236.31 12 512s224.31 500 500 500 500-224.31 500-500S787.69 12 512 12z m0 944.44C266.94 956.44 67.56 757.06 67.56 512S266.94 67.56 512 67.56 956.44 266.94 956.44 512 757.06 956.44 512 956.44z" p-id="1737"></path><path d="M749.63 488.89L416.3 266.67a27.78 27.78 0 0 0-43.19 23.11v444.44a27.78 27.78 0 0 0 43.19 23.11l333.33-222.22a27.78 27.78 0 0 0 0-46.22z m-321 193.44V341.67L684.15 512z">
          </path>
        </svg>
      </div>
    ...
    <div class="v3d-footer" ref="refFooter">
      ...
      <button
        ...
        @click="toggleRecord()"
      >
        <svg class="svg-footer" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          <path
      ...
      <button class="v3d-control v3d-button" type="button" title="Close" aria-disabled="false" @click="close()">
        <svg class="svg-footer" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          <path
            d="M512 1021.72444445c-281.07603513 0-509.72444445-228.64840931-509.72444445-509.72444445S230.92396487 2.27555555 512 2.27555555 1021.72444445 230.92396487 1021.72444445 512 793.07603513 1021.72444445 512 1021.72444445zM512 75.42018617c-240.73610126 0-436.57981383 195.84371143-436.57981383 436.57981383 0 240.69891527 195.84371143 436.57981383 436.57981383 436.57981383 240.69891527 0 436.57981383-195.87894158 436.57981383-436.57981383C948.57981383 271.26389874 752.69891527 75.42018617 512 75.42018617z">
          </path>
...
const createPlayer = (option: V3dPlayerOptions) => {
  ...
  opts.video = {
    ...
    type: type,
    customType: {
      flv: (video: HTMLMediaElement, player: Dplayer) => {
      ...
      hls: (video: HTMLMediaElement, player: Dplayer) => {
        ...
        hls.on(Hls.Events.FRAG_BUFFERED, (frag: Events, data: FragBufferedData) => {
          //
        })
      ...
      flv265: (video: HTMLMediaElement, player: Dplayer) => {
        ...
        canvas.classList.add('dplayer-video', 'dplayer-video-current', 'vjs-canvas')
